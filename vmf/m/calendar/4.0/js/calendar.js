...
function Datepicker() {
	this._defaults = {
		...
		onHoverCB: function(){}, // new variable by suryapavan
		onDisabledDateHoverCB: function(){} // new variable by suryapavan
	};
	this.regional = [];
	...
	_updateInput: function(target, keyUp) {
		...
		if (inst) {
			...
			if ($.isFunction(inst.options.onSelect) && !keyUp && !inst.inSelect) {
				...
				inst.options.onSelect.apply(target, [inst.selectedDates, inst.div]);
				inst.inSelect = false;
			}
		}
	},
	...
	_generateContent: function(target, inst) {
		...
		picker.find(inst.options.renderer.daySelector + ' a').hover(
				function() { 
					...
					inst.options.onHoverCB.call(this, {isMouseOver: true, inst: inst}); 
				},
				function() {
					...
					inst.options.onHoverCB.call(this, {isMouseOver: false, inst: inst});
				}).
			click(function() {
				self._selectDatePlugin(target, this);
			}).end().
			find(inst.options.renderer.daySelector + ' span').mouseover(function(){
				inst.options.onDisabledDateHoverCB.call(this, inst); 
			}).end().
