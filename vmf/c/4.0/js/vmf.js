...
!function($) {
    ...
    Selectpicker.prototype = {
        ...
        init: function() {
            ...
            this.searchBoxPlaceHolderText = this.$element.attr('searchboxplaceholdertext');
            this.liveSearchIconClass = this.$element.attr('liveSearchIconClass');
            this.customStyleClass = this.$element.attr('customStyleClass');
        ...
        createDropdown: function() {
            ...
            var searchBoxPlaceHolderText = this.searchBoxPlaceHolderText || '';
            var liveSearchIconClass = this.liveSearchIconClass ? (" " + this.liveSearchIconClass) : '';
            var customStyleClass = this.customStyleClass ? (" " + this.customStyleClass) : '';

            var header = this.options.header ? '<div class="popover-title"><button type="button" class="close" aria-hidden="true">&times;</button>' + this.options.header + '</div>' : '';
            var searchbox = this.options.liveSearch ? '<div class="bootstrap-select-searchbox"><input type="text" class="input-block-level form-control' + liveSearchIconClass + '" placeholder = "' + searchBoxPlaceHolderText + '" autocomplete="off" /></div>' : '';
            var actionsbox = this.options.actionsBox ? '<div class="bs-actionsbox">' +
                            ...
                            '</div>' : '';
            var drop =
                '<div class="btn-group bootstrap-select' + multiple + inputGroup + customStyleClass +'">' +
    ...
    $.fn.selectpicker = function(option, event) {
       ...
       var chain = this.each(function() {
            if ($(this).is('select')) {
                ...
                if (!data) {
					/** Added Custom code **/
					  $this.next(".bootstrap-select").remove();
    ...
    $(document)
        ...
        .on('keypress', '.bootstrap-select [data-toggle=dropdown], .bootstrap-select [role=menu], .bootstrap-select-searchbox input', function(e) {
            // var $options, $select, ctrl = this; 
            // ctrl.buffer = (ctrl.buffer || "");
            // $select  = $(ctrl).parents('.bootstrap-select').prev('select[selectpicker]');
            // $options = $(ctrl).parents('.bootstrap-select').prev('select[selectpicker]').find('option');
            ...
            // console.log(ctrl.buffer);                    
            // var re = new RegExp("^" + ctrl.buffer + ".*", "i");
            // var optionVal = $options.filter( function() {return $(this).text().match(re);}).first().val();
...
vmf.configs = ({   
	...
	baseUrl :"//"+_getDomain()+_getPort()+"/vmf",
