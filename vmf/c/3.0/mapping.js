...
var vmf_modules = ({
	mapping: {
		...
		"base":{js:["/m/base/1.0/jquery.accessibleTooltip.js","/m/base/1.0/jquery.json-1.3.min.js","/m/base/1.0/min1.js","/m/base/1.0/get_html_translation_table.js"], dependendJs: null,dependendModule: null,vmfpath:true,loadOnce: true},
		...
		// Tree view module
		"treeview" :{js:["/m/treeview/1.0/jquery.treelist.datafetch.js","/m/treeview/1.0/jquery.treelist.js"],css:["/m/treeview/1.0/jquery.treelist.css"],dependendJs: null,dependendModule: ["base"],vmfpath:true,loadOnce: true},
		...
		"haschange":{js:["/m/hashChange/1.0/hashchange.js"],dependendJs: null,dependendModule: ["base"],vmfpath:true,loadOnce: true},
		"autosuggest": {js:["/m/autosuggest/1.0/jquery.autosuggest.js"], css:["/m/autosuggest/1.0/autosuggest.css"] ,dependendJs: null,dependendModule: ["base"], vmfpath:true,loadOnce: true },
		"multicalendar": {js:["/m/multicalendar/1.0/jquery.calendars.js"], css:["/m/multicalendar/1.0/calender.picker.css"] ,dependendJs: null,dependendModule: ["base"], vmfpath:true,loadOnce: true },
        "zeroClipboard":{js:["/m/zeroClipboard/1.0/ZeroClipboard.js","/m/zeroClipboard/1.0/scale.js"],dependendJs: null,dependendModule: ["base"],vmfpath:true,loadOnce: true},
		...
		//elq module
		"elqNow":{js:["/m/elqNow/1.0/elqCfg.js","/m/elqNow/1.0/elqImg.js"],dependendJs: null,dependendModule: ["base"],vmfpath:true,loadOnce: true },
		//Foresee module
