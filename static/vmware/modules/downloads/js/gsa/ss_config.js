 ...
 * @type {string}
 */
var ss_form_element = 'dl_search_form'; // search form
...
if (typeof(downloadsSearch) == "undefined")  downloadsSearch = {};
if (typeof(downloadsSearch.globalVar) == "undefined")  downloadsSearch.globalVar = {};

/**
 * Suggestion type name to display when there is only one suggestion.
 * @type {string}
 */
var ss_g_one_name_to_display = (typeof(downloadsSearch.globalVar.Suggestion) != "undefined") ? downloadsSearch.globalVar.Suggestion : "Suggestion";

/**
 * Suggestion type name to display when there are more than one suggestions.
 * @type {string}
 */
var ss_g_more_names_to_display = (typeof(downloadsSearch.globalVar.Suggestions) != "undefined") ? downloadsSearch.globalVar.Suggestions : "Suggestions";
...
var dsca_host = window.location.hostname;
var ss_gsa_host = dsca_host + "/gsa/suggest";
...
var ss_protocol = SS_OUTPUT_FORMAT_LEGACY;
