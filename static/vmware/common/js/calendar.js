			...
			return this.each(
				function()
				{
					...
					if (!alreadyExists && s.createButton) {
						// create it!
						controller.button = $('<a href="#" class="dp-choose-date" title="Choose Date">' + $.dpText.TEXT_CHOOSE_DATE + '</a>')
								.bind(
									'click',
									function()
									{
 ...
 **/
	...
	$.dpText = {
		...
		TEXT_CLOSE			:	'Close',
		TEXT_CHOOSE_DATE	:	'<img src="http://www.vmware.com/files/images/icons/calendar/calendar.png" />'
	};
	// version
...
vmf.calendar = function($){
    return {
      build: function(elems, config){
          ...
          elems = (elems instanceof jQuery) ? elems : jQuery(elems);
          elems.datePicker(config);
          if(config.selectedDate)
              elems.dpSetSelected(config.selectedDate);
      },
      setDate: function(elems, date){
          elems = (elems instanceof jQuery) ? elems : jQuery(elems);
          elems.dpSetSelected(date);
      },
      setStartDate: function(elems, date){
          elems = (elems instanceof jQuery) ? elems : jQuery(elems);
          elems.dpSetStartDate(date);
      },
      setEndDate: function(elems, date){
          elems = (elems instanceof jQuery) ? elems : jQuery(elems);
          elems.dpSetEndDate(date);
      }
    };
}(jQuery);
